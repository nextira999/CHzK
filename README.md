...
`set {채널 id}`로 채널의 ID를 설정합니다. 해당 ID는 반영구적(파일 삭제 전까지)으로 로컬에 저장됩니다.
...
현재 정식적으로 지원을 하지 않으며, 테스트하지 않았습니다.

## 라이선스

모든 소스코드는 MIT 라이선스로 지원됩니다. 자세한 내용은 [LICENSE](https://github.com/nextira999/CHzK/blob/main/LICENSE)를 참고해 주세요.
